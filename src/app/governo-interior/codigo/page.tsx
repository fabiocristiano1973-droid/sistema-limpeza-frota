...
import { FRASE_CENTRAL } from "@/lib/governo-interior/tema";
import { PILARES_CODIGO, type Principio } from "@/lib/governo-interior/types";
import { Cabecalho, Cartao, Carregando, EstadoVazio } from "@/components/governo-interior/ui";
...
export default function MeuCodigoPage() {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Meu Código" subtitulo="Princípios incorporados com evidência real" voltarPara="/governo-interior/mais" />
