...
import { montarPayloadExportacao, nomeArquivoExportacao, validarPayloadImportacao } from "@/lib/governo-interior/exportacao";
import { gerarICS } from "@/lib/governo-interior/ics";
import type { ConfiguracaoLembretes } from "@/lib/governo-interior/types";
import { nomeDiaSemana } from "@/lib/governo-interior/date";
import {
  BotaoPrimario,
  BotaoSecundario,
  Cabecalho,
...
export default function ConfiguracoesPage() {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Configurações" voltarPara="/governo-interior/mais" />
