...
import { sugerirClassificacoes } from "@/lib/governo-interior/classificacao";
import { dataInputParaIso, isoParaDataInput } from "@/lib/governo-interior/date";
import type { ClassificacaoEvidencia, Principio, Valor } from "@/lib/governo-interior/types";
...
export default function RegistrarSituacaoPage() {
  ...
  async function salvar() {
    ...
    try {
      ...
      router.push(`/governo-interior/registrar/${nova.id}`);
    } finally {
      setSalvando(false);
    }
  }
  ...
  return (
    <div className="flex min-h-full flex-col px-4 pb-8 pt-4">
      <Cabecalho titulo="Registrar situação" voltarPara="/governo-interior" />
