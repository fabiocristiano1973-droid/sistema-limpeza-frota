...
import type { ClassificacaoEvidencia, Principio, Situacao, Valor } from "@/lib/governo-interior/types";
...
export default function DetalheSituacaoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Situação registrada" subtitulo="Reveja e ajuste sempre que precisar" voltarPara="/governo-interior" />
