...
import { excluirValor, listarSituacoesPorValor, obterValor, salvarValor } from "@/lib/governo-interior/db";
import { formatarDataBR } from "@/lib/governo-interior/date";
import type { Situacao, Valor } from "@/lib/governo-interior/types";
import {
  AreaTexto,
  BotaoPrimario,
  BotaoSecundario,
...
export default function DetalheValorPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function excluir() {
    ...
    router.push("/governo-interior/valores");
  }

  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo={valor.nome} voltarPara="/governo-interior/valores" />
