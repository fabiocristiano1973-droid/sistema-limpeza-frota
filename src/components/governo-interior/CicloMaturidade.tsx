...
import { CICLO_MATURIDADE, LABEL_ESTAGIO, type EstagioMaturidade } from "@/lib/governo-interior/types";
import { avaliarAvancoParaEstagio, indiceEstagio, type EstatisticasPrincipio } from "@/lib/governo-interior/maturidade";
