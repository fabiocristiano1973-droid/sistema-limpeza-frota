...
import { formatarDataBR, inicioDaSemana, nomeDiaSemana } from "@/lib/date";
import { PERGUNTA_CENTRAL } from "@/lib/tema";
import type { ConfiguracaoLembretes, Principio, Situacao } from "@/lib/types";
import { LABEL_CLASSIFICACAO } from "@/lib/types";
import { Cartao, Chip, Carregando, EstadoVazio, LinkBotao, Selecao } from "@/components/ui";
...
export default function GovernoInteriorHome() {
  ...
  return (
    <div className="px-4 pb-8 pt-5">
      ...
      <Cartao className="mt-3 border-[#c8a24d]/30 bg-gradient-to-br from-[#1a2438] to-[#121b2c]">
        ...
        {principioSemana ? (
          <>
            ...
            <Link
              href={`/principios/${principioSemana.id}`}
          ...
          <div className="mt-2">
            ...
            <LinkBotao href="/principios/novo">Criar primeiro princípio</LinkBotao>
          </div>
        )}
      </Cartao>
      ...
      <div className="mt-5">
        <LinkBotao href="/registrar" className="min-h-14 text-base">
          + Registrar situação
        </LinkBotao>
      </div>
      ...
      {proximaRevisao && (
        <Cartao className="mt-6">
          ...
          <Link href="/revisao-semanal" className="mt-2 inline-block text-xs font-semibold text-[#e8c877]">
