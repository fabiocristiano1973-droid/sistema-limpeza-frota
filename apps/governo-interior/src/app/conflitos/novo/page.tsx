...
import { criarConflito, listarValores } from "@/lib/db";
import type { Valor } from "@/lib/types";
import { AreaTexto, BotaoPrimario, Cabecalho, Cartao, Carregando, EstadoVazio, LinkBotao, Rotulo, Selecao } from "@/components/ui";
...
export default function NovoConflitoPage() {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Testar conflito" subtitulo="Dois valores, uma decisão" voltarPara="/conflitos" />
