...
import { listarConflitos, listarPrincipios, listarSituacoes } from "@/lib/db";
import { formatarDataBR } from "@/lib/date";
import type { ConflitoValores, Principio, Situacao } from "@/lib/types";
import { LABEL_CLASSIFICACAO } from "@/lib/types";
import { Cabecalho, Cartao, Chip, Carregando, EstadoVazio } from "@/components/ui";
...
export default function PainelEvolucaoPage() {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Painel de evolução" subtitulo="Evidências, não notas" voltarPara="/" />
