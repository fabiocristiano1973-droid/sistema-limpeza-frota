...
import { formatarIntervaloSemana, inicioDaSemana } from "@/lib/date";
import type { Principio, RevisaoSemanal, Situacao } from "@/lib/types";
import {
  AreaTexto,
  BotaoPrimario,
  BotaoSecundario,
...
export default function RevisaoSemanalPage() {
  ...
  if (concluida) {
    return (
      <div className="px-4 pb-10 pt-4">
        <Cabecalho titulo="Revisão semanal" voltarPara="/" />
  ...
  return (
    <div className="flex min-h-full flex-col px-4 pb-8 pt-4">
      <Cabecalho titulo="Revisão semanal" subtitulo={formatarIntervaloSemana(semanaAtualIso)} voltarPara="/" />
