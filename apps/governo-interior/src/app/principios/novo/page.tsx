...
import { criarPrincipio, listarValores } from "@/lib/db";
import { PALETA_PRINCIPIOS } from "@/lib/tema";
import { PILARES_CODIGO, type PilarCodigo } from "@/lib/types";
import type { Valor } from "@/lib/types";
import { AreaTexto, BotaoPrimario, Cabecalho, Campo, ListaEditavel, Rotulo, Selecao } from "@/components/ui";
...
export default function NovoPrincipioPage() {
  ...
  async function salvar() {
    ...
    try {
      ...
      router.push(`/principios/${novo.id}`);
    } finally {
      setSalvando(false);
    }
  }
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Novo princípio" voltarPara="/principios" />
