...
import { LABEL_ESTAGIO } from "@/lib/types";
...
export default function ListaPrincipiosPage() {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo="Princípios" subtitulo="Do descobrir ao incorporar" voltarPara="/" />

      <div className="mt-4">
        <LinkBotao href="/principios/novo">+ Novo princípio</LinkBotao>
      </div>
