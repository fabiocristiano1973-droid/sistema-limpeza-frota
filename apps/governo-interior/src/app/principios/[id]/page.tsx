...
import { calcularEstatisticas } from "@/lib/maturidade";
import { formatarDataBR } from "@/lib/date";
import { PALETA_PRINCIPIOS } from "@/lib/tema";
import { PILARES_CODIGO, type EstagioMaturidade, type PilarCodigo, type Principio, type Situacao, type Valor } from "@/lib/types";
import CicloMaturidade from "@/components/CicloMaturidade";
import {
  AreaTexto,
  BotaoPrimario,
  BotaoSecundario,
...
export default function DetalhePrincipioPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="px-4 pb-10 pt-4">
      <Cabecalho titulo={principio.nome} voltarPara="/principios" />
