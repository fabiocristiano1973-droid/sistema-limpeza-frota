...
const ITENS = [
  { href: "/", rotulo: "Início", icone: "🏠", exato: true },
  { href: "/principios", rotulo: "Princípios", icone: "🧭", exato: false },
  { href: "/registrar", rotulo: "Registrar", icone: "＋", exato: false, destaque: true },
  { href: "/evolucao", rotulo: "Evolução", icone: "📈", exato: false },
  { href: "/mais", rotulo: "Mais", icone: "☰", exato: false },
] as const;
